...
def playGame():
	...
	while (gameOver==0 and (timesGuessed<allowedGuesses)):
        	...
        	while (playerGuess==0):
            		if (timesGuessed==0):
				os.system("espeak 'Guess the correct button. Green, Red, Blue or Yellow. You have 3 guesses left'")
			if (timesGuessed==1):
				os.system("espeak 'Guess the correct button. You have 2 guesses left'")
			if (timesGuessed==2):
				os.system("espeak 'Guess the correct button. This is your last guess'")
        ...
        #Incorrect guess block
            ...
            #Else, player can still play; play "just what do you think you're doing, dave?", reset their guess to 0, restart from top of game loop.
                ...
                if (timesGuessed < allowedGuesses):
					pygame.mixer.init()
...
#def chooseButtonOld():
	...
	#loopcounter = 0 #need to loop the while statement once first
